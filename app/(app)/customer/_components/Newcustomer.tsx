...
export default function CustomerForm() {
  ...
  const onSubmit = async (data: CreateCustomer) => {
    ...
    toast.success("âœ… ØªÙ…Øª Ø¥Ø¶Ø§ÙØ©  Ø¨Ù†Ø¬Ø§Ø­");
  ...
  const customerType = [
    ...
    { id: "individual", name: "ÙØ±Ø¯ÙŠ" },

    { id: "business", name: "ØªØ¬Ø§Ø±ÙŠ" },
  ...
  return (
    ...
    <Dailogreuse
      ...
      titel="Ø¥Ø¶Ø§ÙØ© Ù…Ø³ØªØ®Ø¯Ù…"

      style="sm:max-w-6xl"

      description="Ø£Ø¯Ø®Ù„ ØªÙØ§ØµÙŠÙ„ Ø§Ù„Ù…Ø³ØªØ®Ø¯Ù… Ø£Ø¯Ù†Ø§Ù‡."
          ...
          <div className="grid gap-4">
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
              ...
              <div className="grid gap-2">
                ...
                <Label htmlFor="state">Ø§Ù„Ù…Ø­Ø§ÙØ¸Ø©</Label>
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-4">
              ...
              <div className="grid gap-2">
                ...
                <Label htmlFor="customerType">Ù†ÙˆØ¹ Ø§Ù„Ø¹Ù…ÙŠÙ„</Label>
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-4">
              ...
              <div className="grid gap-2">
                ...
                <Label htmlFor="creditLimit"> Ø­Ø¯ Ø§Ù„Ø¯ÙŠÙˆÙ†</Label>
              ...
              <div className="grid gap-2">
                ...
                <Label htmlFor="outstandingBalance">
                  ...
                  Ø±ØµÙŠØ¯ Ø§ÙØªØªØ§Ø­ÙŠ (Ø§Ù„Ø¯ÙŠÙˆÙ†)
              ...
              <div className="grid gap-2">
                ...
                <Label htmlFor="balance">Ø±ØµÙŠØ¯ Ø§ÙØªØªØ§Ø­ÙŠ (Ø§Ù„Ø±ØµÙŠØ¯)</Label>
