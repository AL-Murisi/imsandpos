...
export default function CustomerStatement({
  ...
  if (!company) {
    return (
      <div className="flex h-[67vh] flex-col overflow-hidden p-3">
  ...
  return (
    <Card className="@container/card h-[89vh] border-transparent bg-transparent px-2">
      {/* فورم البحث */}
        ...
        <div className="bg-accent flex w-full flex-col rounded-lg p-6 shadow">
          ...
          <div className="mb-6 rounded p-4">
            <div className="grid grid-cols-3 gap-4">
              <div>
                <strong>اسم العامل:</strong> {customers.customer?.name}
              </div>
              {/* <div>
